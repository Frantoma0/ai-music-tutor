...
function paletteForNote(note, judgement) {
  return JUDGEMENT_PALETTES[judgement] || notePalette(note);
}
...
function drawNote(
  ...
  */
  ...
  const palette = paletteForNote(note, judgement);
...
export function WaterfallCanvas({
  ...
  }, [notes, currentTime, effectiveMusicalTime, tempo, noteDisplayMode, noteViewMode, judgements]);
